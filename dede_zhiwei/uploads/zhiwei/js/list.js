...
function editArc(aid){
	if(aid==0) aid = getOneItem();
	location="archives_do.php?id="+aid+"&dopost=editArchives";
}
function delArc(aid){
	var qstr=getCheckboxItem();
	if(aid==0) aid = getOneItem();
	location="archives_do.php?qstr="+qstr+"&id="+aid+"&dopost=delArchives";
}
function updateArc(aid){
	var qstr=getCheckboxItem();
	if(aid==0) aid = getOneItem();
	location="archives_do.php?id="+aid+"&dopost=makeArchives&qstr="+qstr;
}
